...
export const getStoreCategoryById = async (maloaidaily) => {
  try {
    const response = await fetch(
      `http://127.0.0.1:8000/loaidaily/maloaidaily/${maloaidaily}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const getAllStoreCategoryName = async () => {
  try {
    const response = await fetch(
      `http://127.0.0.1:8000/loaidaily/tenloaidaily/`
    );
    const data = await response.json();
    return data;
  } catch (error) {
...
export const updateStoreCategory = async (id, tenloaidaily, sotiennotoida) => {
  try {
    const response = await fetch(
      `http://127.0.0.1:8000/loaidaily/capnhat/${id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
