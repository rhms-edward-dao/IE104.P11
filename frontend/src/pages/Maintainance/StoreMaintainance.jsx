...
import { addMaintainanceApi, getMaintainanceApi } from "../../assets/Stores/StoreData";
                ...
                <div className="flex flex-wrap justify-between my-3">
                    <div className="m-5 w-full lg:w-7/12 bg-white dark:bg-[#363636] transition-colors duration-300 shadow-lg dark:text-white">
                        <div className="my-8 mx-5 space-y-8">
                            ...
                            <div className="flex flex-wrap gap-10">
                                ...
                                <h3 className="text-lg font-[400]">{storeData.Daily[0].tendaily}</h3>
                            </div>   
                            <div className="flex flex-wrap gap-10 items-center">
                                <label htmlFor="predictedPrice" className="text-lg font-bold">Chi phí bảo trì (dự kiến)</label>
                                <input 
                                    id="predictedPrice"
                                    name="predictedPrice"
                                    type="number"
                            ...
                            <div className>
                                <label htmlFor="description" className="text-lg font-bold">Mô tả</label>
                                <br></br>
                                <div className="mt-5">
                                    <textarea 
                                        id="description"
                    ...
                    <div className="m-5 w-full lg:w-4/12">
                        ...
                        <div className="mt-2 h-[5rem] bg-white dark:bg-[#363636] transition-colors duration-300 shadow-lg dark:text-white flex flex-wrap items-center justify-center gap-5">
                            ...
                            <button 
                                onClick={() => addMaintainance(price, description, state[0].startDate, state[0].endDate)}
                    ...
                    <table className="mt-5 w-full text-center text-black transition-colors duration-300 dark:text-white">
                        <thead className="border-b-4 border-red-500">
                            <tr className="text-lg">
                                ...
                                <th className="border-r-2 p-2" scope="col">Mô tả</th>
