            ...
            <div className="my-8 mx-4 bg-white dark:bg-[#363636] transition-colors duration-300 rounded-lg shadow-lg">
              <div className="p-4 pr-6">
                <div className="flex justify-between">
                  ...
                  <NavLink
                    className="hidden flex items-center gap-2 rounded-lg bg-green-500 px-4 py-2 font-bold text-white"
                ...
                <div className="mx-2 my-8 flex justify-center text-black dark:text-white transition-colors duration-300">
                  ...
                  <p className="w-1/4 italic justify-start">{storeData.Daily[0].tendaily}</p>
                </div>
                <div className="mx-2 my-8 flex justify-center text-black dark:text-white transition-colors duration-300">
                  <h3 className="w-1/4 text-xl font-semibold justify-center">
                    Loại đại lý:
                  </h3>
                  <p className="w-1/4 italic justify-start">{storeData.Daily[0].tenloaidaily}</p>
                </div>
                <div className="mx-2 my-8 flex justify-center text-black dark:text-white transition-colors duration-300">
                  <h3 className="w-1/4 text-xl font-semibold justify-center">
                    Ngày tiếp nhận:
                  </h3>
                  <p className="w-1/4 italic justify-start">{storeData.Daily[0].ngaytiepnhan}</p>
                </div>
                <div className="mx-2 my-8 flex justify-center text-black dark:text-white transition-colors duration-300">
                  <h3 className="w-1/4 text-xl font-semibold justify-center">
                    Số điện thoại:
                  </h3>
                  <p className="w-1/4 italic justify-start">{storeData.Daily[0].sodienthoai}</p>
                </div>
                <div className="mx-2 my-8 flex justify-center text-black dark:text-white transition-colors duration-300">
                  <h3 className="w-1/4 text-xl font-semibold justify-center">
                    Địa chỉ
                  </h3>
                  <p className="w-1/4 italic justify-start">{storeData.Daily[0].diachi}</p>
                </div>
