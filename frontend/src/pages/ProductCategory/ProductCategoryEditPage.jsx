...
import { updateOneCategory, getProductTypeById } from "../../assets/TypeOfProduct";
...
function WarehousesEditPage() {
    ...
    return (
        <div>
            ...
            <div>                
                <div>
                    ...
                    <div className='flex mt-5'>
                        <div className='w-1/2'>
                            <p className='text-xl font-bold italic'>Chỉnh sửa loại mặt hàng</p>
                        </div>
            ...
            <div className="m-5">
                <div className="block">
                    <label htmlFor="product-category-name-edit" className="font-bold text-lg">Tên loại mặt hàng</label>
                    <br />
                    <input 
