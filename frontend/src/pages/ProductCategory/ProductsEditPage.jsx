...
const ProductAdminAddPage = () => { 
    ...
    const updateData = async(mamathang, tenmathang, dongia, soluongton, tendvt, tenloaimathang, tendaily, hinhanh) => {
        ...
        <div>
                    ...
                    <div className='flex mt-5'>
                        ...
                        <div className='w-1/2 flex justify-end mr-5'>
                            <button 
                                ...
                                onClick={() => updateData(productId, productName, productPrice, productAmount, productUnitName, catName, storeName, imageData)}
                            >
            ...
            <div className="m-5">
                <div className="block space-y-8">
                    ...
                    <div className="space-y-4">
                        <label htmlFor="product-image-edit" className="font-bold text-lg">Hình mặt hàng</label>
                        <br />
                        <input 
