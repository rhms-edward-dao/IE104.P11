...
function StoreCategoryAddPage() {
    ...
    // Need to be complete
    const addData = async(tendaily, tenloaidaily, ngaytiepnhan, sodienthoai, tenquan, tenthanhpho, diachi, hinhanh) => {
    ...
    return (
        <div>
                ...
                <div className='flex mt-5'>
                    ...
                    <div className='w-1/2 flex justify-end mr-5'>
                        <button 
                            ...
                            onClick={() => addData(storeName, catName, dateReceive, phoneNum, districtName, cityName, address, image)}
                        >
            ...
            <div className="m-5">
                ...
                <div className="block py-5">
                    <label htmlFor="date-received-add" className="font-bold text-lg">Ngày tiếp nhận</label>
                    <br />
                    <input 
                ...
                <div className="block py-5">
                    <label htmlFor="address-add" className="font-bold text-lg">Địa chỉ (tới phường)</label>
                    <br />
                    <input 
                        name="address-add" 
                        id="address-add"
                ...
                <div className="block py-5">
                    <label htmlFor="upload-image-store-add" className="font-bold text-xl">Tải hình lên</label>
                    <br />
                    <input 
                        type="file" 
