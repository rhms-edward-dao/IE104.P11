...
function StoreCategoryAddPage() {
    ...
    useEffect(() => {
        ...
        if(existed_data.message === "Không tồn tại đại lý cần tìm") {
            ...
            setAddress(existed_data.Daily[0].diachi.split(',').slice(0, 2).join(", "));
    ...
    const updateData = async(madaily, tendaily, tenloaidaily, ngaytiepnhan, sodienthoai, tenquan, tenthanhpho, diachi, hinhanh) => {        
        ...
        if (check_tendaily && check_tenloaidaily && check_sodienthoai && check_diachi && check_hinhanh) {
            let item = {
                "tendaily": tendaily,
    ...
    return (
        <div>
                ...
                <div className='flex mt-5'>
                    ...
                    <div className='w-1/2 flex justify-end mr-5'>
                        <button 
                            ...
                            onClick={() => updateData(storeId, storeName, catName, dateReceive, phoneNum, districtName, cityName, address, imageData)}
                        >
            ...
            <div className="m-5">
                <div className="block">
                    <label htmlFor="store-name-edit" className="font-bold text-lg">Tên đại lý</label>
                    <br />
                    <input 
                        id="store-name-add" 
                        name="store-name-add" 
                ...
                <div className="block py-5">
                    <label htmlFor="cat-name-add" className="font-bold text-lg">Loại đại lý</label>
                    <br />
                    <select 
                        name="cat-name-add" 
                        id="cat-name-add" 
                ...
                <div className="block py-5">
                    <label htmlFor="date-received-edit" className="font-bold text-lg">Ngày tiếp nhận</label>
                    <br />
                    <input 
                ...
                <div className="block py-5">
                    <label htmlFor="phone-number-add" className="font-bold text-lg">Số điện thoại</label>
                    <br />
                    <input 
                        id="phone-number-add" 
                ...
                <div className="block py-5">
                    <label htmlFor="address-edit" className="font-bold text-lg">Địa chỉ (tới phường)</label>
                    <br />
                    <input 
                        name="address-edit" 
                        id="address-edit"
                ...
                <div className="block py-5">
                    <label htmlFor="upload-image-store-edit" className="font-bold text-xl">Tải hình lên</label>
                    <br />
                    <input 
                        type="file" 
