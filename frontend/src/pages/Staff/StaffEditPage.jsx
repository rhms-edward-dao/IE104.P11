...
import { updateStaff, getStaffById, getAllPositionName } from "../../assets/StaffData";
...
function StaffManagementEditPage() {
    ...
    const updateData = async (manhanvien, hoten, ngaysinh, sodienthoai, email, tendaily, tenchucvu, tenthanhpho, tenquan, diachi, hinhanh) => {
        ...
        const isEmailFormat = (input) => /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$/.test(input);
                    ...
                    <div className='flex mt-5'>
                        ...
                        <div className='w-1/2 flex justify-end mr-5'>
                            <button 
                                ...
                                onClick={() => updateData(staffId, staffName, staffBirthday, staffPhone, staffEmail, staffStore, staffPosition, staffCityName, staffDistrictName, staffAddress, imageData)}
                            >
            ...
            <div className="m-5">
                <div className="block space-y-8">
                    <div className="space-y-4">
                        <label htmlFor="staff-name-add" className="font-bold text-lg">Họ tên nhân viên</label>
                        <br />
                        <input 
                            id="staff-name-add" 
                            name="staff-name-add" 
                    ...
                    <div className="space-y-4">
                        <label htmlFor="birthdate-add" className="font-bold text-lg">Ngày sinh</label>
                        <br />
                        <input 
                            id="birthdate-add" 
                            name="birthdate-add" 
                    ...
                    <div className="space-y-4">
                        <label htmlFor="staff-phone-add" className="font-bold text-lg">Số điện thoại</label>
                        <br />
                        <input 
                            id="staff-phone-add" 
                    ...
                    <div className="space-y-4">
                        <label htmlFor="staff-email-add" className="font-bold text-lg">Email cơ quan</label>
                        <br />
                        <input 
                            id="staff-email-add" 
                    ...
                    <div className="space-y-4">
                        <label htmlFor="position-name-add" className="font-bold text-lg">Chức vụ</label>
                        <br />
                        <select 
                    ...
                    <div className="space-x-20 flex">
                        <div className="space-y-4">
                            <label htmlFor="city-name-add" className="font-bold text-lg">Thành phố</label>
                            <br />
                        ...
                        <div className="space-y-4">
                            <label htmlFor="district-name-add" className="font-bold text-lg">Quận</label>
                            <br />
                            {/* It must be a combobox -> selecting which city you need - fetch all city name from server for showing options */}
                            <select 
                    ...
                    <div className="space-y-4">
                        <label htmlFor="address-add" className="font-bold text-lg">Địa chỉ</label>
                        <br />
                        <input 
                            id="address-add" 
                            name="address-add" 
                    ...
                    <div className="space-y-4">
                        <label htmlFor="image-add" className="font-bold text-lg">Hình ảnh</label>
                        <br />
                        <input 
                            id="image-add" 
                            name="image-add" 
