...
function PositionAddPage() {
    ...
    // Functions here    
    const addData = async (tenchucvu, capdo, luong, thoihan) => {
        ...
        <div>
            ...
            <div>                
                <div>
                    ...
                    <div className='flex mt-5'>
                        <div className='w-1/2'>
                            <p className='text-xl font-bold italic'>{"Thêm chức vụ"}</p>
                        </div>
                        <div className='w-1/2 flex justify-end mr-5'>
                            <button 
                                className='px-2 py-3 bg-red-500 rounded rounded-xl'
                                onClick={() => addData(positionName, level, salary, time)}
                            >
            ...
            <div className="m-5">
                <div className="block space-y-8">
                    ...
                    <div className="space-y-4">
                        <label htmlFor="level-add" className="font-bold text-lg">Cấp độ</label>
                        <br />
                        <input 
                            id="level-add"
                            name="level-add"
                    ...
                    <div className="space-y-4">
                        <label htmlFor="salary-add" className="font-bold text-lg">Lương</label>
                        <br />
                        <input 
                            id="salary-add" 
                            name="salary-add" 
                    ...
                    <div className="space-y-4">
                        <label htmlFor="time-add" className="font-bold text-lg">Thời hạn</label>
                        <br />
                        <input 
                            id="time-add" 
                            name="time-add" 
