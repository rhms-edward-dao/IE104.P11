...
function StaffManagementAddPage() {
    ...
    const addData = async (hoten, ngaysinh, sodienthoai, email, tendaily, tenchucvu, tenthanhpho, tenquan, diachi, hinhanh) => {
                    ...
                    <div className='flex mt-5'>
                        ...
                        <div className='w-1/2 flex justify-end mr-5'>
                            <button 
                                ...
                                onClick={() => addData(staffName, staffBirthday, staffPhone, staffEmail, staffStore, staffPosition, staffCityName, staffDistrictName, staffAddress, imageData)}
                            >
